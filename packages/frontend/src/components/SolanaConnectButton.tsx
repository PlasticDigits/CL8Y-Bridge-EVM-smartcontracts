        ...
        >
          <div className="text-right hidden sm:block">
            <p className="text-sm font-mono font-medium text-white">
              {solBalance ?? '--'} <span className="text-purple-400">SOL</span>
            </p>
            <p className="text-xs text-gray-500">{formatAddress(address, 4)}</p>
          </div>
            ...
            <div className="absolute right-0 mt-2 w-48 glass border-2 border-white/35 rounded-none shadow-[4px_4px_0_#000] overflow-hidden z-50 animate-fade-in-up" style={{ animationDuration: '0.2s' }}>
              <div className="p-2">
                <div className="px-3 py-2 sm:hidden">
                  <p className="text-sm font-mono text-white">{solBalance ?? '--'} SOL</p>
