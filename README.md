...
| [Frontend bridge UI invariants](./docs/FRONTEND_BRIDGE_INVARIANTS.md) | Recipient field: Terra bech32, EVM EIP-55, Solana pubkey (INV-RCP1; GL-117); symbol-only token logos (INV-FE-TOKEN-LOGO-1; GL-133); Transfer picker economic-then-test ranking (INV-FE-TOKEN-RANK-1; GL-136) |
