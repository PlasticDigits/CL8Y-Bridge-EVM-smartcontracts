...
| 3.12 | Retry / Cancel for WalletConnect pairing; Retry after Cancel still completes (late success from the cancelled attempt must not drop the in-flight WalletConnect client) | | |
